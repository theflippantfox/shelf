...
const styles = StyleSheet.create({
  ...
  totalDisplayLabel: {...typeScale.caption, marginBottom: spacing.sm, textTransform: 'uppercase', letterSpacing: 1},
  totalDisplayValue: {fontSize: 40, fontWeight: '800'},
  sectionTitle: {...typeScale.tiny, marginBottom: spacing.md, textTransform: 'uppercase', letterSpacing: 0.5},
  ...
  paymentMethodText: {...typeScale.title, marginLeft: 4, fontWeight: '600'},
  confirmButton: {
    marginTop: 'auto',
    borderRadius: radii.lg,
    paddingVertical: 18,
